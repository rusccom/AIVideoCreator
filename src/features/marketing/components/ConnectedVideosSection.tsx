  ...
  return (
    <section className="section section-muted" id="continuity">
      <div className="container">
        ...
        <p className="section-copy">AI Video Director helps you continue a video naturally from one scene to the next. Instead of collecting random AI clips or hiding cuts with editing tricks, you build a connected timeline where the final export feels like one continuous video.</p>
