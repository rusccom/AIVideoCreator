...
export async function getAdminMetrics() {
  const [users, queuedJobs, failedJobs, credits, storage, activeSubscriptions, reasoning] =
    await prisma.$transaction([
      ...
      prisma.reasoningModel.aggregate({
  ...
  return [
    ...
    { label: "Stripe active", value: `${activeSubscriptions}` },
