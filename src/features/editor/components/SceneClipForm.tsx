...
export function SceneClipForm(props: SceneClipFormProps) {
  ...
  return (
    <form onSubmit={submitScene(props, form, model, setError, setSaving)}>{error ? <div className="form-error">{error}</div> : null}{promptField(form, setForm)}{videoOptions(props, form, model, setForm, changeModel)}{startFrameField(props, form, setForm)}{sceneActions(props, saving)}</form>
  );
}

function submitScene(props: SceneClipFormProps, form: SceneFormState, model: EditorVideoModel | undefined, setError: SetText, setSaving: SetBoolean) {
...
function modelSelect(props: SceneClipFormProps, form: SceneFormState, changeModel: (modelId: string) => void) {
...
function startFrameField(props: SceneClipFormProps, form: SceneFormState, setForm: SetForm) {
...
function sceneActions(props: SceneClipFormProps, saving: boolean) {
